...
import internal.org.jboss.serial.classmetamodel.ClassResolver;
import internal.org.jboss.serial.exception.SerializationException;
import internal.org.jboss.serial.finalcontainers.BooleanContainer;
import internal.org.jboss.serial.finalcontainers.ByteContainer;
import internal.org.jboss.serial.finalcontainers.CharacterContainer;
import internal.org.jboss.serial.finalcontainers.DoubleContainer;
import internal.org.jboss.serial.finalcontainers.FloatContainer;
import internal.org.jboss.serial.finalcontainers.IntegerContainer;
import internal.org.jboss.serial.finalcontainers.LongContainer;
import internal.org.jboss.serial.finalcontainers.ShortContainer;
import internal.org.jboss.serial.objectmetamodel.safecloning.SafeCloningRepository;
import internal.org.jboss.serial.util.StringUtil;
import internal.org.jboss.serial.util.StringUtilBuffer;
...
/**
 * DataContainer is a Container of Immutables and Object References. It
 * emmulates the repository as it would be a DataOutputStream and
 * DataInputStream
 * 
...
public class DataContainer extends DataExport implements DataContainerConstants, Externalizable {
	...
	/**
	 * I used the transient tag as a documentation feature. this contains the root
	 * objectCache being used. It would be possible to use ThreadLocals for this.
	 * But I didn't want to take the risk of having problems when the application
	 * was running in ThreadPools generating leaks.
	 */
	...
	public DataContainer(ClassLoader loader, ObjectSubstitutionInterface substitution, SafeCloningRepository safeToReuse,
	...
	public DataContainer(ClassLoader loader, ObjectSubstitutionInterface substitution, SafeCloningRepository safeToReuse,
	    boolean checkSerializable, StringUtilBuffer buffer) {
		this();

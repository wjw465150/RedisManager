...
import internal.org.jboss.serial.finalcontainers.FinalContainer;
...
public class FieldsContainer {
	 ...
	 * not required by RegularObjectPersister to create an intermediate HashMap to
	 * read its fields. Becuase of that we have opted in keep static methods on
	 * FieldsContainer that will expose low level persistent operations
	 */
	/*
	 * public static void writeNumberOfFields(ObjectOutput out, int fields) throws
	 * IOException { out.writeInt(fields); }
	 */
	...
	/**
	 * both {@link org.jboss.serial.persister.RegularObjectPersister) and
	 * readMyself need to produce the same binary compatible output while it's not
	 * required by RegularObjectPersister to create an intermediate HashMap to
	 * read its fields. Becuase of that we have opted in keep static methods on
	 * FieldsContainer that will expose low level persistent operations
	 */
	/*

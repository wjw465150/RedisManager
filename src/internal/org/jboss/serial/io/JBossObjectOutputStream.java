...
package internal.org.jboss.serial.io;

import internal.org.jboss.serial.exception.SerializationException;
import internal.org.jboss.serial.objectmetamodel.DataContainer;
import internal.org.jboss.serial.objectmetamodel.DataContainerConstants;
...
public class JBossObjectOutputStream extends ObjectOutputStream implements DataContainerConstants {
	 ...
	 * has also the capability of creating Buffers on ThreadLocal over demand, but
	 * having these buffers pre-created is more efficient
	 */
	...
	public void writeObjectUsingDataContainer(Object obj) throws IOException {
		DataContainer dataContainer = new DataContainer(null, this.getSubstitutionInterface(), checkSerializableClass,
		    buffer);
		if (output instanceof DataOutputStream) {
			dataOutput = (DataOutputStream) output;
		} else {
	...
	public Object smartClone(Object obj, SafeCloningRepository safeToReuse, ClassLoader loader) throws IOException {
		...
		DataContainer container = new DataContainer(loader, this.getSubstitutionInterface(), safeToReuse,
		    checkSerializableClass, buffer);

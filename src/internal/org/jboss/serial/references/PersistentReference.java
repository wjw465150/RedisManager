...
package internal.org.jboss.serial.references;
...
/**
 * Base class for persistent references. Persistent reference is a Weak/Soft
 * reference to a reflection object. If the reflection object is garbage
 * collected, the reference is then rebuilt using reflection operations.
 * 
 * @author csuconic
 * 
 */
public abstract class PersistentReference {
	 ...
	 * 
	 * @param clazz
	 *          The clazz being used on this object (where we will do reflection
	 *          operations)
	 * @param referencedObject
	 *          The reflection object being used
	 * @param referenceType
	 *          if REFERENCE_WEAK will use a WeakReference, and if REFERENCE_SOFT
	 *          will use a SoftReference for referencedObject
	 */

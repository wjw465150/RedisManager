...
/**
 * This class respects definitions on
...
public class StringUtil {
	...
	private static void pullDataToBuffer(DataInput input, StringUtilBuffer.Position pos, byte[] byteBuffer,
	    long currentPosition, long size) throws IOException {
		pos.pos = 0;

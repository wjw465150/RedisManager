...
package internal.org.jboss.serial.util;

import internal.gnu.trove.TObjectHashingStrategy;
import internal.org.jboss.serial.references.EmptyReference;
import internal.org.jboss.serial.references.PersistentReference;

/**
 * Contribution made by Bob Morris. To improve performance we should use
 * EMPTY_CLASS_ARRAY and EMPTY_OBJECT_ARRAY instead of creating an instance
 * every time we need.
 * 
 * @author Bob Morris
 */

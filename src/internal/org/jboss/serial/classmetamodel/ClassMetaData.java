...
import internal.org.jboss.serial.references.MethodPersistentReference;
import internal.org.jboss.serial.references.PersistentReference;
import internal.org.jboss.serial.util.ClassMetaConsts;
import internal.org.jboss.serial.util.HashStringUtil;
...
public class ClassMetaData implements ClassMetaConsts {
	...
	private void exploreSlots(Class clazz) {
		...
		if (!this.isExternalizable() && !this.isArray && this.isSerializable()) {
			for (Class classIteration = clazz; classIteration != null && Serializable.class.isAssignableFrom(classIteration); classIteration = classIteration
			    .getSuperclass()) {

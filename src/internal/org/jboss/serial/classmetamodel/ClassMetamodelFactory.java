...
import internal.org.jboss.serial.util.FastHashMap;
import internal.org.jboss.serial.util.PartitionedWeakHashMap;
...
public class ClassMetamodelFactory implements ClassMetaConsts {
	 ...
	 * code was created by Carlos de Wolf on a fix of EJBTHREE-440. By coincidence
	 * I needed to parse primitive values, and instead of reinventing the wheel I
	 * got the same code.
	 */
	...
	private static ClassMetaData getClassMetaData(String clazzName, ClassLoader loader, boolean checkSerializable)
	    throws IOException {
	...
	public static ClassMetaData getClassMetaData(String clazzName, ClassResolver resolver, ClassLoader loader,
	    boolean checkSerializable) throws IOException {
		try {
	...
	public static boolean isImmutable(Class clazz) {
		return (clazz == Character.class || clazz == String.class || clazz == Long.class || clazz == Byte.class
		    || clazz == Double.class || clazz == Float.class || clazz == Integer.class || clazz == Short.class

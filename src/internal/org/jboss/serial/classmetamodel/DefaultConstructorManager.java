...
/**
 * If SunConstructorManager is not available in this current JVM, we will use
 * the default one which only looks for the default constructor at the current
 * class $Id: DefaultConstructorManager.java,v 1.3 2006/03/16 16:25:02 csuconic
 * Exp $
 * 

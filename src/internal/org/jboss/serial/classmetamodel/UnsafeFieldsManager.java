 ...
 * 
 * This FieldsManager uses the only hook available to change final fields into
 * JVM 1.4 (operations with sun.misc.Unsafe). As this is a reflection
 * functionality, we've gotten the Unsafe instance used by

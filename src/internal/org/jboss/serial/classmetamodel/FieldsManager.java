 ...
 * 
 * FieldsManager is the class responsible to manage changing the fields. It will
 * be up to implementations of this class to decide wether we should use Unsafe
 * operations or pure reflection
 * 
...
public abstract class FieldsManager {
	 ...
	 * In case negative we will use UnsafeFieldsManager and this class will be

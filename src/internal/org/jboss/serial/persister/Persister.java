...
/**
 * Interface used to define how to load complex objects from the repository or
 * streaming $Id: Persister.java,v 1.11 2006/04/24 23:49:40 csuconic Exp $
 * 
...
public interface Persister {
	 ...
	 * @param referenceId
	 * @param cache
	 *          It's the persister job to assign the cache with a created object,
	 *          right after its creation, as if in case of circular references
	 *          those references are respected.
	 * @param input
	 * @param substitution
	 * @return
	 * @throws IOException

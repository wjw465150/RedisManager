...
public class ArrayPersister implements Persister {
	...
	private Object readObjectArray(ClassMetaData metaData, int referenceId, ObjectsCache cache, int length,
	    ObjectInput input) throws ClassNotFoundException, IOException {
		final int depth = metaData.getArrayDepth();

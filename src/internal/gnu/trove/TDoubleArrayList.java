 ...
 * @version $Id: TDoubleArrayList.java,v 1.12 2003/03/19 05:07:11 ericdf Exp $
 */
...
public class TDoubleArrayList implements Serializable, Cloneable {
	...
	/**
	 * Grow the internal array as needed to accomodate the specified number of
	 * elements. The size of the array doubles on each resize unless
	 ...
	 * method can be used as an alternative to the {@link #clear clear} method if
	 * you want to recyle a list without allocating new backing arrays.
	 * 
	 * @see #clear
	 */
	public void reset() {
	 ...
	 * Sets the size of the list to 0, but does not change its capacity. This
	 * method can be used as an alternative to the {@link #clear clear} method if
	 * you want to recyle a list without allocating new backing arrays. This
	 * method differs from {@link #reset reset} in that it does not clear the old
	 * values in the backing array. Thus, it is possible for {@link #getQuick
	 * getQuick} to return stale data if this method is used and the caller is
	 * careless about bounds checking.
	 * 
	 * @see #reset
	 * @see #clear
	 * @see #getQuick
	 ...
	 * @return true if other is a TDoubleArrayList and has exactly the same
	 *         values.
	 */

...
public final class HashFunctions {
	 ...
	 * </pre>
	 * 
	 * </blockquote> using <code>int</code> arithmetic, where <code>d[i]</code> is
	 * the <i>i</i>th digit of the value, counting from the right, <code>n</code>
	 * is the number of decimal digits of the specified value, and <code>^</code>
	 * indicates exponentiation. (The hash value of the value zero is zero.)
	 * 
	 * @return a hash code value for the specified value.
	 */
	...
	public static final int hash(long value) {
		...
		/*
		 * The hashcode is computed as <blockquote><pre> 31^5*(d[0]*31^(n-1) +
		 * d[1]*31^(n-2) + ... + d[n-1]) </pre></blockquote> using <code>int</code>
		 * arithmetic, where <code>d[i]</code> is the <i>i</i>th digit of the value,
		 * counting from the right, <code>n</code> is the number of decimal digits
		 * of the specified value, and <code>^</code> indicates exponentiation. (The
		 * hash value of the value zero is zero.)
		 * 

...
abstract public class TDoubleHash extends TPrimitiveHash implements Serializable, TDoubleHashingStrategy {
	...
	/**
	 * Creates a new <code>TDoubleHash</code> instance with the default capacity
	 * and load factor.
	 */
	public TDoubleHash() {
		super();
	...
	/**
	 * Creates a new <code>TDoubleHash</code> instance with a prime value at or

...
import internal.gnu.trove.TDoubleFloatHashMap;
import internal.gnu.trove.TDoubleFloatIterator;
 ...
 * TDoubleFloatHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TDoubleFloatHashMapDecorator.java,v 1.1 2002/09/25 05:10:08
 *          ericdf Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TDoubleFloatHashMapDecorator.this.containsKey(k) && TDoubleFloatHashMapDecorator.this.get(k)
					    .equals(v));
				} else {
					return false;
				}

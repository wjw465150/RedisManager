...
import internal.gnu.trove.TDoubleObjectHashMap;
import internal.gnu.trove.TDoubleObjectIterator;
 ...
 * TDoubleObjectHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TDoubleObjectHashMapDecorator.java,v 1.1 2002/09/25 05:10:08
 *          ericdf Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TDoubleObjectHashMapDecorator.this.containsKey(k) && TDoubleObjectHashMapDecorator.this.get(k)
					    .equals(v));
				} else {
					return false;
				}

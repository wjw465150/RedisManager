...
import internal.gnu.trove.TFloatIntHashMap;
import internal.gnu.trove.TFloatIntIterator;
 ...
 * TFloatIntHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TFloatIntHashMapDecorator.java,v 1.1 2002/09/25 05:10:08 ericdf
 *          Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TFloatIntHashMapDecorator.this.containsKey(k) && TFloatIntHashMapDecorator.this.get(k).equals(v));
				} else {
					return false;
				}
			}

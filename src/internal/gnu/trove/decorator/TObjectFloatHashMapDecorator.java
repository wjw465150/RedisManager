...
import internal.gnu.trove.TObjectFloatHashMap;
import internal.gnu.trove.TObjectFloatIterator;
 ...
 * TObjectFloatHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TObjectFloatHashMapDecorator.java,v 1.1 2002/09/25 05:10:09
 *          ericdf Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TObjectFloatHashMapDecorator.this.containsKey(k) && TObjectFloatHashMapDecorator.this.get(k)
					    .equals(v));
				} else {
					return false;
				}

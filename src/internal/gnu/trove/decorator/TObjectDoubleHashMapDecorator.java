...
import internal.gnu.trove.TObjectDoubleHashMap;
import internal.gnu.trove.TObjectDoubleIterator;
 ...
 * TObjectDoubleHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TObjectDoubleHashMapDecorator.java,v 1.1 2002/09/25 05:10:09
 *          ericdf Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TObjectDoubleHashMapDecorator.this.containsKey(k) && TObjectDoubleHashMapDecorator.this.get(k)
					    .equals(v));
				} else {
					return false;
				}

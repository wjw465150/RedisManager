...
import internal.gnu.trove.TLongObjectHashMap;
import internal.gnu.trove.TLongObjectIterator;
 ...
 * TLongObjectHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TLongObjectHashMapDecorator.java,v 1.1 2002/09/25 05:10:09
 *          ericdf Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TLongObjectHashMapDecorator.this.containsKey(k) && TLongObjectHashMapDecorator.this.get(k).equals(v));
				} else {
					return false;
				}
			}

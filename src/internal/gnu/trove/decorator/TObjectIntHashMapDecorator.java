...
import internal.gnu.trove.TObjectIntHashMap;
import internal.gnu.trove.TObjectIntIterator;
 ...
 * TObjectIntHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TObjectIntHashMapDecorator.java,v 1.1 2002/09/25 05:10:09
 *          ericdf Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TObjectIntHashMapDecorator.this.containsKey(k) && TObjectIntHashMapDecorator.this.get(k).equals(v));
				} else {
					return false;
				}
			}

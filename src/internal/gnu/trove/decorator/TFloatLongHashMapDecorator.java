...
import internal.gnu.trove.TFloatLongHashMap;
import internal.gnu.trove.TFloatLongIterator;
 ...
 * TFloatLongHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TFloatLongHashMapDecorator.java,v 1.1 2002/09/25 05:10:08
 *          ericdf Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TFloatLongHashMapDecorator.this.containsKey(k) && TFloatLongHashMapDecorator.this.get(k).equals(v));
				} else {
					return false;
				}
			}

...
import internal.gnu.trove.TIntIntHashMap;
import internal.gnu.trove.TIntIntIterator;
...
/**
 * Wrapper class to make a TIntIntHashMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TIntIntHashMap and translates
 ...
 * @version $Id: TIntIntHashMapDecorator.java,v 1.1 2002/09/25 05:10:08 ericdf
 *          Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TIntIntHashMapDecorator.this.containsKey(k) && TIntIntHashMapDecorator.this.get(k).equals(v));
				} else {
					return false;
				}
			}

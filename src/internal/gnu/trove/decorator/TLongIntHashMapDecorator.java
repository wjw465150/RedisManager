...
import internal.gnu.trove.TLongIntHashMap;
import internal.gnu.trove.TLongIntIterator;
...
/**
 * Wrapper class to make a TLongIntHashMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TLongIntHashMap and translates
 ...
 * @version $Id: TLongIntHashMapDecorator.java,v 1.1 2002/09/25 05:10:09 ericdf
 *          Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TLongIntHashMapDecorator.this.containsKey(k) && TLongIntHashMapDecorator.this.get(k).equals(v));
				} else {
					return false;
				}
			}

...
package internal.gnu.trove.decorator;

import internal.gnu.trove.TIntLongHashMap;
import internal.gnu.trove.TIntLongIterator;
...
/**
 * Wrapper class to make a TIntLongHashMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TIntLongHashMap and translates
 ...
 * @version $Id: TIntLongHashMapDecorator.java,v 1.1 2002/09/25 05:10:08 ericdf
 *          Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TIntLongHashMapDecorator.this.containsKey(k) && TIntLongHashMapDecorator.this.get(k).equals(v));
				} else {
					return false;
				}
			}
					...
					public Object next() {
						...
						return new Map.Entry() {
							...
							public boolean equals(Object o) {
								return ((o instanceof Map.Entry) && ((Map.Entry) o).getKey().equals(key) && ((Map.Entry) o).getValue()
								    .equals(val));
							}

...
import internal.gnu.trove.TLongLongHashMap;
import internal.gnu.trove.TLongLongIterator;
 ...
 * TLongLongHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TLongLongHashMapDecorator.java,v 1.1 2002/09/25 05:10:09 ericdf
 *          Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TLongLongHashMapDecorator.this.containsKey(k) && TLongLongHashMapDecorator.this.get(k).equals(v));
				} else {
					return false;
				}
			}

...
import internal.gnu.trove.TFloatFloatHashMap;
import internal.gnu.trove.TFloatFloatIterator;
 ...
 * TFloatFloatHashMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * 
 * <p>
 ...
 * @version $Id: TFloatFloatHashMapDecorator.java,v 1.1 2002/09/25 05:10:08
 *          ericdf Exp $
 * @since trove 0.1.8
 */
		...
		return new AbstractSet() {
			...
			public boolean contains(Object o) {
				if (o instanceof Map.Entry) {
					...
					return (TFloatFloatHashMapDecorator.this.containsKey(k) && TFloatFloatHashMapDecorator.this.get(k).equals(v));
				} else {
					return false;
				}
			}

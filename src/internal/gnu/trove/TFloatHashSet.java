...
public class TFloatHashSet extends TFloatHash implements Serializable {
	...
	/**
	 * Creates a new <code>TFloatHashSet</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TFloatHashSet</code> instance containing the elements
	 * of <tt>array</tt>.
	 * 
	 * @param array
	...
	/**
	 * Creates a new <code>TFloatHash</code> instance with the default capacity
	 * and load factor.
	 * 
	 * @param strategy
	...
	/**
	 * Creates a new <code>TFloatHash</code> instance with a prime value at or

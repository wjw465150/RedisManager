 ...
 */
package internal.com.thoughtworks.xstream.io.xml;

import internal.com.thoughtworks.xstream.core.util.XmlHeaderAwareReader;
...
public class XppDriver extends AbstractXmlDriver {
    ...
    private void loadLibrary() {
        if (!xppLibraryPresent) {
            try {
                Class.forName("internal.org.xmlpull.mxp1.MXParser", false, getClass().getClassLoader());
